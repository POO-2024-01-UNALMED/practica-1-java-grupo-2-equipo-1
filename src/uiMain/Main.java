    ...
    public static void main(String[] args){
        ...
        while(!logueado) {
        	...
        	if (opcion_log==1) {
        		...
        		//aca se le pide al usuario la facultad a la que se va a registrar
        		String facul = null;
        		while(true) {
        			...
        			if(fac<=0||fac>Coordinador.getFacultades().length) {
        				System.out.println("Valor invalido. Intente nuevamente");; //si el scanner detecta que el usuario ingreso un numero mayor 
        			}                                                             //a la longitud de las facultades, suelta error
        			else {
        				facul = Coordinador.getFacultades()[fac-1]; // caso contrario, obtiene el numero de facultad ingresado, resta uno al scanner
        				break;
        			}
        		}
